...
test("CarTypesGet returns status code 200 and an array of four objects ", async () => {
  let req = {
    header: {},
  };
...
test("CarTypesGet returns an array with two objects that have the color of red", async () => {
  let req = {
    header: {},
  };
...
test("CarTypesGet returns an array with two objects that have a registration in the year of 2016", async () => {
  let req = {
    header: {},
  };
...
test("CarTypesGet returns an array with no objects that have a capacity of 2", async () => {
  let req = {
    header: {},
  };
...
test("CarTypesGet returns an array with one object that have a capacity greater than 5", async () => {
  let req = {
    header: {},
  };
